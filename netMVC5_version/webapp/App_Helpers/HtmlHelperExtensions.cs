...
namespace SmartAdminMvc
{
    public static class HtmlHelperExtensions
    {
        ...
        {
            var setting =SmartAdminMvc.Settings.GetValue<bool>(appSetting);
        ...
        {
            var copyright =
                string.Format("{0} &copy; {1} {2}", helper.AssemblyVersion(), DateTime.Now.Year, SmartAdminMvc.Settings.Company)
                    .Trim();
        ...
        private static void SetDisplayVersion()
        {
            ...
            _displayVersion =
                string.Format("{4} {0}.{1}.{2} (build {3})", version.Major, version.Minor, version.Build,
                    version.Revision, SmartAdminMvc.Settings.Project).Trim();
        }
